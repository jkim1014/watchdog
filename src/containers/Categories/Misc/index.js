  ...
  render() {
    ...
    return (
      <div>
        ...
        <Query query={GET_MISC} variables={{ category: 'm', lon: store.get('geo').longitude.toString(), lat: store.get('geo').latitude.toString(), walking: store.get('walking').walking}}>
          {({ loading, error, data }) => {
